...
pub static INITIAL_CONSONANTS: Lazy<Vec<&'static str>> = Lazy::new(|| vec![
    "b", "d", "đ", "g", "gh", "m", "n", "nh", "p", "ph", "r", "s", "t", "tr", "v", "z",
    "c", "h", "k", "kh", "qu", "th",
    "ch", "gi", "l", "ng", "ngh", "x",
    "đ", "l", // duplicates in source? kept for compatibility
    "h",
    "", // Empty initial is valid
]);

// Valid vowel sequences
pub static VOWELS: Lazy<Vec<&'static str>> = Lazy::new(|| vec![
    "ê", "i", "ua", "uê", "uy", "y",
    "a", "iê", "oa", "uyê", "yê",
...
pub static FINAL_CONSONANTS: Lazy<Vec<&'static str>> = Lazy::new(|| vec![
    "ch", "nh",
    "c", "ng",
    "m", "n", "p", "t",
    "k",
    "c",
    "", // Empty final is valid
]);
...
static VOWEL_SEQS: &[&str] = &[
    ...
    "a iê oa uyê yê",                                                                 // Group 1
    "â ă e o oo ô ơ oe u ư uâ uô ươ",                                                 // Group 2
    "oă",                                                                             // Group 3
    "uơ",                                                                             // Group 4
